...
**Not for:**
- Cloud topology (AWS/Azure/GCP design) → `cloud-architect`
- Distributed-systems resilience patterns → `microservices-architect`
- API surface design → `api-designer` / `graphql-architect`
